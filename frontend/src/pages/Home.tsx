    ...
    <>
      ...
      <section className="hero-section">
        ...
        <div className="hero-content krishi-container">
          ...
          <div className="hero-actions fade-in-up delay-3">
            <Link to="/dashboard" className="btn-krishi-primary hero-cta">
              <i className="fa-solid fa-rocket"></i> {t('home_start_cta')}
            </Link>
            <Link to="/chatbot" className="btn-krishi-secondary hero-cta-2">
      ...
      <section className="services-section krishi-container">
        ...
        <div className="services-grid">
          <Link to="/disease" className="service-card fade-in-up">
          ...
          <Link to="/soil" className="service-card fade-in-up delay-1">
          ...
          <Link to="/weather" className="service-card fade-in-up delay-2">
          ...
          <Link to="/chatbot" className="service-card fade-in-up delay-3">
          ...
          <Link to="/market" className="service-card fade-in-up delay-1">
          ...
          <Link to="/machinery" className="service-card fade-in-up delay-2">
          ...
          <Link to="/schemes" className="service-card fade-in-up delay-3">
          ...
          <Link to="/voice" className="service-card fade-in-up delay-1">
      ...
      <section className="cta-banner fade-in-up">
        <div className="krishi-container cta-inner">
          ...
          <Link to="/dashboard" className="btn-krishi-primary cta-btn">
