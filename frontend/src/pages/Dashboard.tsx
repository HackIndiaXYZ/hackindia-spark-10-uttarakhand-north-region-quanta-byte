    ...
    <div className="krishi-container dashboard-wrap">
      ...
      <div className="summary-grid fade-in-up delay-1">
        ...
        <div className="summary-card status-danger">
          ...
          <div className="summary-badge danger"><Link to="/alerts" style={{ color: 'inherit' }}>{t('dash_alerts_view')}</Link></div>
        </div>
      </div>
      ...
      <div className="dash-mid-row fade-in-up delay-3">
        ...
        <div className="krishi-card disease-status-card">
          <div className="card-header">
            ...
            <Link to="/disease" className="btn-krishi-secondary btn-sm">{t('dash_new_check')}</Link>
          </div>
          {recentDiseases && recentDiseases.length > 0 ? (
            ...
            <div className="empty-state">
              ...
              <Link to="/disease" className="btn-krishi-primary btn-sm">{t('dash_check_now')}</Link>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="dash-bottom-row fade-in-up delay-4">
        ...
        <div className="krishi-card weather-mini-card">
          <div className="card-header">
            ...
            <Link to="/weather" className="btn-krishi-secondary btn-sm">{t('dash_weather_details')}</Link>
          </div>
        ...
        <div className="krishi-card yield-progress-card">
          <div className="card-header">
            ...
            <Link to="/yield" className="btn-krishi-secondary btn-sm">{t('dash_full_report')}</Link>
          </div>
